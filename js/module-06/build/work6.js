...
var Hamburger = function () {
  ...
  _createClass(Hamburger, [{
    ...
    value: function removeTopping(topping) {
      this.toppings = this.toppings.filter(function (element) {
    ...
    value: function calculatePrice() {
      var toppingPrice = this.toppings.reduce(function (arr, value) {
        return arr + Hamburger.TOPPINGS[value].price;
      }, 0);
      var totalPrice = Hamburger.SIZES[this.size].price + Hamburger.STUFFINGS[this.stuffing].price + toppingPrice;
      return totalPrice;
    }
    ...
    value: function calculateCalories() {
      var toppingCalories = this.toppings.reduce(function (arr, value) {
        return arr + Hamburger.TOPPINGS[value].calories;
      }, 0);
      var totalCalories = Hamburger.SIZES[this.size].calories + Hamburger.STUFFINGS[this.stuffing].calories + toppingCalories;
